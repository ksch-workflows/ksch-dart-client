...
@JsonSerializable()
class CreatePatientPayload extends _BasePatientPayload {
  CreatePatientPayload({String? name}) : super(name: name);

  factory CreatePatientPayload.fromJson(Map<String, dynamic> json) => _$CreatePatientPayloadFromJson(json);
